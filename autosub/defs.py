### Functions used for autosub
### Defined separately due to an issue with Pool
import audioop
import math
import wave
import subprocess
...
def which(program):
    ...
    def is_exe(file_path):
        ...
        if sys.platform == 'darwin':
            ...
            return os.path.isfile(file_path + '.exe') and os.access(file_path + '.exe', os.X_OK)
        else:
            print('Only Windows and Mac currently supported. Exiting.')
            sys.exit(1)
